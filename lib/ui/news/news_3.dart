...
class NewsPaper3 extends StatefulWidget {
  @override
  _NewsState createState() => _NewsState();
}

class _NewsState extends State<NewsPaper3> {
  List _posts = [];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Berita Republika Terbaru')),
  ...
  Future _getData() async {
    ...
    try {
      final response =
          await http.get(Uri.parse('https://berita-indo-api.vercel.app/v1/republika-news'));
