...
class NewsPaper1 extends StatefulWidget {
  @override
  _NewsState createState() => _NewsState();
}

class _NewsState extends State<NewsPaper1> {
  List _posts = [];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Berita CNBC Terbaru Indonesia')),
  ...
  Future _getData() async {
    ...
    try {
      final response =
          await http.get(Uri.parse('https://berita-indo-api.vercel.app/v1/cnbc-news'));
